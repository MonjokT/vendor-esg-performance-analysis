# Vendor ESG Performance Analysis
...
- **Dashboard** — A fully formatted visual dashboard with KPI cards, charts, 
  and ranked tables for at-a-glance executive reporting.
